...
local function chat_stats(chat_id)
  ...
  local text = 'Members in ID:'..chat_id.."\n\n"
  for k,user in pairs(users_info) do
    text = text..user.name..' = '..user.msgs..'\n\n'
  end
  local file = io.open("./data/groups/"..chat_id.."stats.txt", "w")
  file:write(text)
  file:flush()
  file:close() 
  send_document("channel#id"..chat_id,"./data/groups/"..chat_id.."stats.txt", ok_cb, false)
  return --text
end
